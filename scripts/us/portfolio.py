...
# ── 비중 상수 (정본) ────────────────────────────────────────────────────
EQUITY_FAMILY = 48.0     # 주식·메모리·AI 인프라를 합친 주식 패밀리
EQUITY_STEP = 5.0
MEMORY_NEUTRAL, MEMORY_STEP = 3.0, 1.5      # 중립이 0이면 UW를 표현할 수 없다
AI_NEUTRAL, AI_STEP = 3.0, 1.5
FI_TOTAL = 30.0          # 채권 등급은 배분이 아니라 듀레이션 — 합계는 고정
FI_LONG_SHARE, FI_LONG_STEP = 0.5, 0.2
METALS_NEUTRAL, METALS_STEP = 6.0, 3.0
ENERGY_NEUTRAL, ENERGY_STEP = 3.0, 3.0
FX_STEP = 5.0            # 달러 뷰는 부호로 상품이 갈린다

SLEEVES = (
    ('equity_core', '주식 코어', ('SPY',)),
    ('memory', '메모리', ('MU', 'WDC', 'STX')),
    ('ai_infra', 'AI 인프라', ('MRVL', 'COHR', 'LITE', 'GEV', 'VRT')),
    ('bonds_long', '채권 장기(7-10Y)', ('IEF',)),
