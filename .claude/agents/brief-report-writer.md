...
**시황 분량 (2026-08-28 사용자 지시 「시황정리가 부족하다」):** 「오늘의 장」+주식+FX+원자재를 합쳐 **4,000~4,500자**를 목표로 한다(2026-08-27 발행본은 2,095자로 매크로 한 섹션의 44%였다). 매크로 섹션을 넘기지는 않는다. **`band`가 「미미」인 자산은 한 줄로 지나간다** — 분량을 채우려고 모든 자산을 같은 무게로 쓰라는 뜻이 아니다.
