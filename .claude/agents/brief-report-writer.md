...
8. **멀티에셋 매니저 전략** — 전일 스탠스 리뷰 + 스탠스 표(주식/채권/FX/원자재/메모리/AI 인프라) + 리스크 시나리오 2-3개. **아래 상세 사양을 반드시 따른다. 이 섹션만은 그날 데이터로 새로 쓰는 것이 아니라 전일 포지션을 승계한다.**
...
### 섹션 8. 멀티에셋 매니저 전략 — 상세 사양 (2026-08-17 사용자 지시)
